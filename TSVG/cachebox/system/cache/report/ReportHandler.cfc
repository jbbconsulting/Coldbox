...
<!----------------------------------------- CONSTRUCTOR ------------------------------------->			
	...
	<cffunction name="init" access="public" returntype="ReportHandler" hint="Constructor" output="false" >
		<cfargument name="cacheBox" 	 	type="cachebox.system.cache.CacheFactory" required="true" hint="The cache factory binded to"/>
		...
		<cfscript>
			...
			variables.skinPath  = "/cachebox/system/cache/report/skins/#arguments.skin#";
