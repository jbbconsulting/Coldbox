...
* @doc_abstract true
*/
component serializable=false implements="cachebox.system.cache.policies.IEvictionPolicy" accessors="true"{
	...
	* @cacheProvider.doc_generic cachebox.system.cache.ICacheProvider
	*/
	...
	*/
	...
	/**
	* Get utiliy object
	* @return cachebox.system.core.util.Util
	*/
