...
----------------------------------------------------------------------->
<cfcomponent output="false" extends="cachebox.system.cache.providers.CacheBoxProvider" implements="cachebox.system.cache.IColdboxApplicationCache">
	...
	<cffunction name="init" access="public" output="false" returntype="any" hint="Constructor">
		<cfscript>
			...
			// URL Facade Utility
			instance.eventURLFacade		= CreateObject("component","cachebox.system.cache.util.EventURLFacade").init(this);
...
<!------------------------------------------- ColdBox Application Related Operations ------------------------------------------>
    ...
    <cffunction name="setColdbox" output="false" access="public" returntype="void" hint="Set the coldbox application reference">
    	<cfargument name="coldbox" type="any" required="true" hint="The coldbox application reference as cachebox.system.web.Controller" colddoc:generic="cachebox.system.web.Controller"/>
