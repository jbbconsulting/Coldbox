...
Or look in the /cachebox/system/cache/store/sql/*.sql for you sql script for your DB.
----------------------------------------------------------------------->
<cfcomponent hint="I am a cool cool JDBC Store for CacheBox" output="false" implements="cachebox.system.cache.store.IObjectStore">
	...
	<cffunction name="init" access="public" output="false" returntype="JDBCStore" hint="Constructor">
		...
		<cfscript>
			...
			instance = {
				...
				converter 		= createObject("component","cachebox.system.core.conversion.ObjectMarshaller").init()
			};
			...
			// Indexer
			instance.indexer = createObject("component","cachebox.system.cache.store.indexers.JDBCMetadataIndexer").init(fields, config, this);
