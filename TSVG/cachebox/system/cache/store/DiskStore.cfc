...
----------------------------------------------------------------------->
<cfcomponent hint="I am a disk store, I am not that fancy as I am slower." output="false" implements="cachebox.system.cache.store.IObjectStore">
	...
	<cffunction name="init" access="public" output="false" returntype="DiskStore" hint="Constructor">
		...
		<cfscript>
			...
			instance = {
				...
				indexer    		= createObject("component","cachebox.system.cache.store.indexers.MetadataIndexer").init(fields),
				converter 		= createObject("component","cachebox.system.core.conversion.ObjectMarshaller").init(),
				fileUtils		= createObject("component","cachebox.system.core.util.FileUtils")
			};
