...
----------------------------------------------------------------------->
<cfcomponent extends="cachebox.system.logging.appenders.FileAppender" 
			 output="false"
...
<!------------------------------------------- CONSTRUCTOR ------------------------------------------->
	...
	<cffunction name="init" access="public" returntype="RollingFileAppender" hint="Constructor" output="false">
		...
		<cfscript>
			...
			instance.fileRotator = createObject("component","cachebox.system.logging.util.FileRotator").init();
