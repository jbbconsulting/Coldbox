...
----------------------------------------------------------------------->
<cfcomponent extends="cachebox.system.logging.AbstractAppender" 
			 output="false"
	...
	<cffunction name="init" access="public" returntype="ScopeAppender" hint="Constructor" output="false" >
		...
		<cfscript>
			...
			// Scope storage
			instance.scopeStorage = createObject("component","cachebox.system.core.collections.ScopeStorage").init();
			// Scope Checks
