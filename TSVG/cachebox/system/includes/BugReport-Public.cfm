...
<cfoutput>
<!--- StyleSheets --->
<style type="text/css"><cfinclude template="/cachebox/system/includes/css/cbox-debugger.css.cfm"></style>
<div class="cb-container">
	...
	<div style="margin:10px; color:gray">
		<em>* The full robust errors can be seen by switching the <strong>coldbox.customErrorTemplate</strong> in your configuration file (/config/ColdBox.cfc) to "/cachebox/system/includes/BugReport.cfm" and reloading the application.</em>
	</div>
</div>
</cfoutput>