...
<cfcomponent name="ColdboxProxy" output="false" hint="This component is the coldbox remote proxy used for remote operations." >
	...
	<!--- getRemotingUtil --->
    <cffunction name="getRemotingUtil" output="false" access="private" returntype="cachebox.system.remote.RemotingUtil" hint="Get a reference to the ColdBox Remoting utility class.">
		<cfreturn createObject("component","cachebox.system.remote.RemotingUtil")>
    </cffunction>
	...
	<cffunction name="getCacheBox" output="false" access="private" returntype="any" hint="Get the CacheBox reference." colddoc:generic="cachebox.system.cache.CacheFactory">
	...
	<cffunction name="getRootLogger" output="false" access="private" returntype="cachebox.system.logging.Logger" hint="Get the root logger reference.">
		<cfreturn getLogBox().getRootLogger()>
	</cffunction>

	<!--- Get a logger --->
	<cffunction name="getLogger" output="false" access="private" returntype="cachebox.system.logging.Logger" hint="Get a named logger reference.">
	...
	<cffunction name="getCache" access="private" output="false" returntype="any" hint="Get a CacheBox Cache Provider" colddoc:generic="cachebox.system.cache.IColdboxApplicationCache">
		...
		<cfif not structKeyExists( application, arguments.appKey ) or not application[ arguments.appKey ].getColdboxInitiated() or arguments.reloadApp>
			<cflock type="exclusive" name="#appHash#" timeout="30" throwontimeout="true">
				...
				if ( not structkeyExists( application, arguments.appKey ) OR NOT
					...
					// Load it Up baby!!
					cbController = CreateObject( "component", "cachebox.system.web.Controller" ).init( expandPath(arguments.appMapping), arguments.appKey );
					// Put in Scope
	...
	<!--- Get Simple Util --->
	<cffunction name="getUtil" access="private" output="false" returntype="cachebox.system.core.util.Util" hint="Create and return a util object">
