...
*/
component extends="cachebox.system.FrameworkSupertype" serializable="false" accessors="true"{
	...
	property name="interceptorService" 	type="cachebox.system.services.InterceptorService";
