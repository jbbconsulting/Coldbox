...
component extends="testbox.system.compat.framework.TestCase"  accessors="true"{
	...
	function beforeTests(){
		...
		if( this.loadColdbox ){
			...
			if( structKeyExists( application, getColdboxAppKey() ) ){
				...
				variables.controller = new cachebox.system.testing.mock.web.MockController( appRootPath=appRootPath, appKey=variables.coldboxAppKey );
	...
	* @return cachebox.system.core.util.RequestBuffer
	*/
	function getMockRequestBuffer(){
		return getMockBox().createMock( "cachebox.system.core.util.RequestBuffer" ).init();
	}

	/**
	* I will return a mock controller object
	* @return cachebox.system.testing.mock.web.MockController
	*/
	function getMockController(){
		return CreateObject( "component", "cachebox.system.testing.mock.web.MockController" ).init( '/unittest', 'unitTest' );
	}
	...
	*
	* @return cachebox.system.web.context.RequestContext
	*/
	function getMockRequestContext( boolean clearMethods=false, decorator ){
		...
		if( arguments.clearMethods ){
			...
			return getMockBox().createEmptyMock( "cachebox.system.web.context.RequestContext" );
		}

		// Create functioning request context
		mockRC 			= getMockBox().createMock( "cachebox.system.web.context.RequestContext" );
		mockController = CreateObject( "component", "cachebox.system.testing.mock.web.MockController" ).init('/unittest','unitTest');
	...
	* @return cachebox.system.ioc.Injector
	*/
	function getWireBox(){
	...
	* @return cachebox.system.cache.CacheFactory
	*/
	...
	* @return cachebox.system.logging.LogBox
	*/
	function getLogBox(){
	...
	* Get the RequestContext reference from the running application
	*
	* @return cachebox.system.web.Flash.AbstractFlashScope
	*/
	...
	*
	* @return cachebox.system.context.RequestContext
	*/
	function execute(
		string event = "",
        string route = "",
	...
	*/
	function getUtil(){
		return new cachebox.system.core.util.Util();
	}
