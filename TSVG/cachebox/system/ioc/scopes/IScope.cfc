...
<cfinterface hint="The main interface to produce WireBox storage scopes">
	...
	<!--- init --->
    <cffunction name="init" output="false" access="public" returntype="any" hint="Configure the scope for operation and returns itself" colddoc:generic="cachebox.system.ioc.scopes.IScope">
    ...
    <cffunction name="getFromScope" output="false" access="public" returntype="any" hint="Retrieve an object from scope or create it if not found in scope">
    	<cfargument name="mapping" 			type="any" required="true"  hint="The object mapping" colddoc:generic="cachebox.system.ioc.config.Mapping"/>
