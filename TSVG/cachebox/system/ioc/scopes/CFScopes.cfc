...
----------------------------------------------------------------------->
<cfcomponent output="false" implements="cachebox.system.ioc.scopes.IScope" hint="I am a scopes that stores in valid CF scopes">
    ...
    <cffunction name="getFromScope" output="false" access="public" returntype="any" hint="Retrieve an object from scope or create it if not found in scope">
    	<cfargument name="mapping" 			type="any" required="true" hint="The object mapping: cachebox.system.ioc.config.Mapping" colddoc:generic="cachebox.system.ioc.config.Mapping"/>
